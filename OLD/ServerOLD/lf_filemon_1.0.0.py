#LeakyFaucet Server Filemon v1.0.0
...
# Path to the text file to watch, scratch file for passing data to the SMS caller, and the folder for session logs
    ...
    if os.path.getsize(file_path) > file_size:
        ...
        with open(file_path, 'r') as file:
            ...
            if re.match(r'^1\d{10}$', new_line):
                #Write the phone number into a scratch file for retrieval by the sms caller.
                with open(scratch, "w") as f:
                    f.write(new_line)

                #Call SMS script 
                subprocess.call(["python3", "/home/ubuntu/lf_sms_1.0.0.py"])
